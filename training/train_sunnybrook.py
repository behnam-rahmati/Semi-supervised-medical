...
################### This code includes implementation of the sunnybrook dataset (SCD) with different models  ##########################
...
def train_module(contour_type, folder_name, train_images, train_masks, test_images, test_masks, loss ):
    ...
    for e in range(epochs):
        ...
        if loss == 'CE':
            ...
            model.compile(optimizer = sgd, loss = AAAI2_Loss,
                        metrics=[dice_coef, jaccard_coef, hausdorff_distance], run_eagerly = True)                         
