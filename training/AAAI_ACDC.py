...
# # # # # # # # # # # preparing the labeled and unlabeled train data # # # # # # # # # #
    ...
    for num_ctrs in [51, 74]:
        ...
        save_folder = 'AAAI_lung\\suponly\\'+ str(num_ctrs)+'\\weights\\'+str(itr)
        ...
        for thresh1 in [ 10, 0.000001,  0.001, 0.01, 0.1]:
            ...
            save_folder = 'AAAI_lung\\AC2\\'+ str(num_ctrs) + '\\nofilter\\weights\\'+str(itr)+ "\\" + str(thresh1)
        ...
        save_folder = 'AAAI_lung\\PL\\'+ str(num_ctrs) + '\\nofilter\\weights\\'+str(itr)
