# *********This is a modified version of the original code from Shawn Lankton (www.shawnlankton.com)***********
# Modifications: shape prior term is added to the original code

# This code implements traditional deformable models (chan-vese) with a shape prior term
